        ...
        >
          <View className="flex-1 px-6">
            <View className="flex-1 justify-center">
              ...
              <View className="bg-white rounded-2xl p-6 shadow-md border border-gray-100 mt-4">
                ...
                <TouchableOpacity
                  ...
                  disabled={isLoading}
                  className={`rounded-xl py-4 shadow-sm mt-6 mb-4 ${
                ...
                <TouchableOpacity className="flex-row items-center justify-center mt-4">
                  ...
                  <Text className="text-blue-600 text-md font-semibold ml-1">
                    Resend
                  </Text>
                </TouchableOpacity>
              </View>
